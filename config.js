module.exports = {
    ...
    token: "MTA4NjY4MjA3NjkyNjk2NzgxOA.Gn0EAf.1LD39LDQsn0Z4_BTpIQt2w7pnxE68n3q-oGvnU", //Bot Tokeniniz => Bot Oluşturduktan Sonra Intentsleri Açmayı Unutma!
    guildID: "1086678846016860242", //Kullanıcağın Sunucunun ID'si
    voiceChannelID: "1249400217657151603", // Ses Kanal ID'si
    presence: "parsher Was Here", //Botun Durumu
    footer: "parsher & Luppux", //Embedların Footer Yazısı
    botOwners: ["689447667465453599"], //Bot Sahibinin ID'si
    ...
    symbolparsher: "|", //Kayıt Esnasında İsim Ve Yaş'ı Ayıran Çizgi
    ...
    mongoURL: "mongodb://localhost:27017", //MongoDB URL'niz
