...
module.exports = {
    ...
    execute: async (client, message, args, parsher_embed) => {
        ...
        if (!kanal) return message.reply({ embeds: [parsher_embed.setDescription(`> **Belirtilen Kullanıcı Bir Ses Kanalında Bulunmamakta!**`)] }).sil(5);
